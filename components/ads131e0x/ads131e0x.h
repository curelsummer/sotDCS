...
/****************************************************************/
/* ADS1294 COMMAND DESCRIPTION and definations */
/****************************************************************/
 // System Commands
...
/****************************************************************/
/* ADS1294 register addresses                                  */
/****************************************************************/

#define ADS131E0X_REG_DEVID         (0x0000u)
/* 
 ...
 * |-------|---------|--------|------|--------|--------|--------|------- |
 * |REV_ID5| REV_ID4 |REV_ID3 |  N/A |   N/A  |REV_ID2 |REV_ID1 |REV_ID0 |
 * ----------------------------------------------------------------------
 * 
 * The ID Control Register is programmed during device manufacture to indicate device characteristics.
 * 
 * Bits[7:5] : These bits indicate the device family.
 * 000 = TBD
 * 001 = TBD
 * 010 = TBD
 ...
 * 111 = TBD
 * 
 * Bits[4:3] : Reserved always read back 2h
 * 
 * BIT[2:0] : Channel ID
 * 000 = 4-channel ADS1294 or ADS1294R
 * 001 = 6-channel ADS1294 or ADS1294R
 * 010 = 8-channel ADS1294 or ADS1294R
 * 011 = Reserved
 * 111 = Reserved
 *              
*/

#define ADS131E0X_REG_CONFIG1       (0x0001u)
/*
 * 
 ...
 * --------------------------------------------------------------
 */
#define ADS131E0X_REG_CONFIG2       (0x0002u)
...
#define ADS131E0X_REG_LOFF       (0x0003u)
...
#define ADS131E0X_REG_CH1SET        (0x0004u)
...
#define ADS131E0X_REG_CH2SET        (0x0005u)
/*    CHnSET: Individual Channel Settings
 *     Address = 05h
 *--------------------------------------------------------------------------------
 * | BIT 7    |BIT 6    |BIT 5   |  BIT 4  | BIT 3  | BIT 2  |  BIT 1  | BIT 0      |
...
#define ADS131E0X_REG_RLD_SENS      (0x0006u)
/*
 * RLD_SENSP
 * Address = 06h
 *---------------------------------------------------------------------------------------
...
#define ADS131E0X_REG_LOFF_SENS     (0x0007u)
/*
 * LOFF_SENS
 * Address = 07h
 *--------------------------------------------------------------------------------
...
#define ADS131E0X_REG_LOFF_STAT      (0x0008u)
/*
 * LOFF_STAT
 * Address = 08h
 *--------------------------------------------------------------------------------------------
 ...
 *  
 */
#define ADS131E0X_REG_RESP1     (0x009u)
/*
...
#define ADS131E0X_REG_RESP2      (0x00Au)
/*
 ...
 */
#define ADS131E0X_REG_GPIO     (0x00Cu)
/*
...
#define DR_HR_32K   (0x80)
#define DR_HR_16K   (0x81)
#define DR_HR_8K    (0x82)
#define DR_HR_4K    (0x83)
#define DR_HR_2K    (0x84)
#define DR_HR_1K    (0x85)
#define DR_HR_500   (0x86)

#define DR_LP_16K   (0x00)
#define DR_LP_8K    (0x01)
#define DR_LP_4K    (0x02)
#define DR_LP_2K    (0x03)
#define DR_LP_1K    (0x04)
#define DR_LP_500   (0x05)
#define DR_LP_250   (0x06)


#define CHANNEL_POWER_DOWN  (0x80)

#define CHANNEL_GAIN_1      (0x10)
#define CHANNEL_GAIN_2      (0x20)
#define CHANNEL_GAIN_3      (0x30)
#define CHANNEL_GAIN_4      (0x40)
#define CHANNEL_GAIN_6      (0x00)
#define CHANNEL_GAIN_8      (0x50)
#define CHANNEL_GAIN_12     (0x60)

#define CHANNEL_INPUT_NORMAL        (0x00)
#define CHANNEL_INPUT_SHORT         (0x01)
#define CHANNEL_INPUT_RLD_MEASURE   (0x02)
#define CHANNEL_INPUT_MVDD          (0x03)
#define CHANNEL_INPUT_TEMP          (0x04)
#define CHANNEL_INPUT_TEST          (0x05)
#define CHANNEL_INPUT_RLD_DRP       (0x06)
#define CHANNEL_INPUT_RLD_DRN       (0x07)

#define TOTAL_REG_NUM (13)
